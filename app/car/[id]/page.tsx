...
import { ArrowLeft, History, Navigation, Activity, MapIcon, ChevronDown, ChevronUp, Clock, MapPin, DollarSign, Ticket, Loader2 } from "lucide-react"
                            ...
                            <div className="pt-4">
                              ...
                              <div className="space-y-2">
                                ...
                                {trip.destinations.map((dest, idx) => {
                                  const isPassed = dest.isPassed === true || dest.isPassed === 'true'
